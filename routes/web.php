...
Route::group([
    ...
    Route::group(['middleware' => ['admin.auth','permission']], function () {
        ...
        Route::prefix('employees/{employee}/profile')->name('employees.profile.')->group(function () {
            ...
            Route::get('discipline/{discipline}/attachment', [EmployeeProfileController::class, 'viewDisciplineAttachment'])->name('discipline.attachment');
            ...
            Route::get('documents/{document}/view', [EmployeeProfileController::class, 'viewDocument'])->name('documents.view');
            Route::put('documents/{document}', [EmployeeProfileController::class, 'updateDocument'])->name('documents.update');
            Route::delete('documents/{document}', [EmployeeProfileController::class, 'destroyDocument'])->name('documents.destroy');
        ...
        Route::post('employees/attendance/quick-approved-time-leave', [AttendanceController::class, 'quickApproveTimeLeave'])->name('attendances.quick-approved-time-leave');
        ...
        Route::patch('employee-salaries/update-cycle/{employeeId}/{cycle}', [EmployeeSalaryController::class, 'changeSalaryCycle'])->name('employee-salaries.update-salary-cycle');
        ...
        Route::delete('employee-salaries/salary/{employeeId}', [EmployeeSalaryController::class, 'deleteSalary'])->name('employee-salaries.delete-salary');
