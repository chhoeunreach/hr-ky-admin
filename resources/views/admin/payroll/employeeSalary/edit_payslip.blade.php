    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if ($('#payroll_status').val() !== '{{ $paidStatus }}') {
                $('#monthly_basic_salary, .income_amount, .additional_income_amount, .deduction_amount, .additional_deduction_amount, #ssf_deduction,#pf_deduction, #bonus, #tada, #advanceSalary, #absentDeduction, #overtime, #undertime').on('input', debounce(function () {
