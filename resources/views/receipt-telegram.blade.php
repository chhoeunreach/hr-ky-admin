...
<head>
    ...
    <title>Receipt to Telegram</title>
    <style>
...
<body>
    <div class="card">
        ...
        <form method="POST" action="{{ route('receipt.telegram.send') }}" enctype="multipart/form-data">
            @csrf
        ...
        <p class="hint">បំពេញព័ត៌មានវិក្កយបត្រ រួចចុចផ្ញើទៅកាន់ Telegram</p>
    </div>
