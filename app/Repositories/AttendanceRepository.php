...
class AttendanceRepository
{
    ...
    private function dailyAttendanceQuery($filterParameter, bool $summaryOnly = false)
    {
        ...
        $select = $summaryOnly ? [
            ...
            DB::raw('COALESCE(office_times.opening_time, user_office_times.opening_time) AS attendance_office_opening_time'),
            DB::raw('COALESCE(office_times.closing_time, user_office_times.closing_time) AS attendance_office_closing_time'),
            DB::raw('COALESCE(office_times.is_early_check_out, user_office_times.is_early_check_out, 0) AS is_early_check_out'),
            DB::raw('COALESCE(office_times.checkout_before, user_office_times.checkout_before) AS checkout_before'),
            ...
            'time_leaves.reasons AS time_leave_reason',
