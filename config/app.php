...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value is used when generating the QR code consumed by the mobile
    | application. Set it when the mobile app should connect to a different
    | host or port than the web admin panel.
    |
    */
