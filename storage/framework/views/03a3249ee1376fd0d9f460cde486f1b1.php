                ...
                <div class="container">
                    <form class="forms-sample" id="editAttendance" action=""  method="post">
                        ...
                        <div class="row">
                            ...
                            <label for="exampleFormControlSelect1" class="form-label"><?php echo e(__('index.admin_edit_remark')); ?></label>
                            <div class="col-lg-12 mb-3">
...
<?php /**PATH /var/www/hr-ky-admin1/resources/views/admin/attendance/common/edit-attendance-form.blade.php ENDPATH**/ ?>