<?php $__env->startSection('title', __('index.create_notice')); ?>
...
<?php $__env->startSection('main-content'); ?>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form id="notification" class="forms-sample" action="<?php echo e(route('admin.notices.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hr-ky-admin1/resources/views/admin/notice/create.blade.php ENDPATH**/ ?>