<script>
    $(document).ready(function(){
        ...
        $('#checkIn').click(function (event) {
            ...
            Swal.fire({
                title: '<?php echo e(__('index.confirm_check_in')); ?>',
                showDenyButton: true,
        ...
        $('#checkOut').click(function (event) {
            ...
            let href = $(this).attr('href');
            Swal.fire({
                title: '<?php echo e(__('index.confirm_check_out')); ?>',
                showDenyButton: true,
                confirmButtonText: `<?php echo e(__('index.yes')); ?>`,
                denyButtonText: `<?php echo e(__('index.no')); ?>`,
                padding: '10px 50px 10px 50px',
        ...
        $('.editAttendance').click(function (event) {
            ...
            $('.modal-title').html('<?php echo e(__('index.edit_attendance_title', ['name' => ':name', 'date' => ':date'])); ?>'.replace(':name', name).replace(':date', date));
        ...
        $('.addEmployeeAttendance').click(function (event) {
            ...
            $('.add-modal-title').html('<?php echo e(__('index.create_attendance_title', ['name' => ':name', 'date' => ':date'])); ?>'.replace(':name', name).replace(':date', cdate));
            $('#addDate').val(date);
            $('#empId').val(user_id);
...
<?php /**PATH /var/www/hr-ky-admin1/resources/views/admin/attendance/common/scripts.blade.php ENDPATH**/ ?>