<nav class="page-breadcrumb d-flex align-items-center justify-content-between">
    <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.attendances.index')); ?>"><?php echo e(__('index.attendance_section')); ?></a></li>
...
<?php /**PATH /var/www/hr-ky-admin1/resources/views/admin/attendance/common/breadcrumb.blade.php ENDPATH**/ ?>