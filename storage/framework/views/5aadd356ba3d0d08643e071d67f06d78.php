<nav class="page-breadcrumb d-flex align-items-center justify-content-between">
    <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.leaves.index')); ?>"><?php echo e(__('index.leave_type_section')); ?></a></li>
...
<?php /**PATH /var/www/hr-ky-admin1/resources/views/admin/leaveType/common/breadcrumb.blade.php ENDPATH**/ ?>