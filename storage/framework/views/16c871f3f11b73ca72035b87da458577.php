<nav class="page-breadcrumb d-flex align-items-center justify-content-between">
    <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.users.index')); ?>"><?php echo e(__('index.user_section')); ?></a></li>
...
<?php /**PATH /var/www/hr-ky-admin1/resources/views/admin/users/common/breadcrumb.blade.php ENDPATH**/ ?>