<nav class="page-breadcrumb d-flex align-items-center justify-content-between">
    <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.routers.index')); ?>"><?php echo app('translator')->get('index.router_section'); ?></a></li>
...
<?php /**PATH /var/www/hr-ky-admin1/resources/views/admin/router/common/breadcrumb.blade.php ENDPATH**/ ?>