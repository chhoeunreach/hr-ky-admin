<?php $__env->startSection('title', __('index.create_employee')); ?>

<?php $__env->startSection('action', __('index.add')); ?>
...
<?php $__env->startSection('main-content'); ?>
    ...
    <section class="content">
        ...
        <div class="card-user">
            <form class="forms-sample" id="employeeDetail" action="<?php echo e(route('admin.employees.store')); ?>" enctype="multipart/form-data" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/hr-ky-admin1/resources/views/admin/employees/create.blade.php ENDPATH**/ ?>