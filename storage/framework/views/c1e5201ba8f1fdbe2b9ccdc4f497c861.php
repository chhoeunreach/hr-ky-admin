<script>
    ...
    $(document).ready(function (e) {
        ...
        $('body').on('click', '.delete', function (event) {
            ...
            Swal.fire({
                title: '<?php echo e(__('index.delete_support_confirm', ['title' => ':name'])); ?>'.replace(':name', title),
                showDenyButton: true,
                confirmButtonText: `<?php echo app('translator')->get('yes'); ?>`,
                denyButtonText: `<?php echo app('translator')->get('no'); ?>`,
    ...
    $(document).ready(function (e) {
        const departmentId = "<?php echo e($filterParameters['department_id'] ?? ''); ?>";
        const branchId = "<?php echo e($filterParameters['branch_id'] ?? ''); ?>";
...
<?php /**PATH /var/www/hr-ky-admin1/resources/views/admin/support/common/scripts.blade.php ENDPATH**/ ?>