<script>
    $('document').ready(function(){
        ...
        let tasksChart = new Chart(document.getElementById("tasksChart"), {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        <?php echo e($taskPieChartData['not_started']); ?>,
                        <?php echo e($taskPieChartData['on_hold']); ?>,
                        <?php echo e($taskPieChartData['in_progress']); ?>,
                        <?php echo e($taskPieChartData['completed']); ?>,
                        <?php echo e($taskPieChartData['cancelled']); ?>
        ...
        let barData = [
            <?php echo e($projectCardDetail['not_started']); ?>,
            <?php echo e($projectCardDetail['on_hold']); ?>,
            <?php echo e($projectCardDetail['in_progress']); ?>,
            <?php echo e($projectCardDetail['completed']); ?>,
            <?php echo e($projectCardDetail['cancelled']); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hr-ky-admin1/resources/views/admin/dashboard_scripts.blade.php ENDPATH**/ ?>