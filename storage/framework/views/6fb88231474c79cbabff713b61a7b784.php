...
<script src="<?php echo e(asset('assets/js/dashboard-light.js')); ?>"></script>
...
<script src="<?php echo e(asset('assets/js/nepaliDatepicker.min.js')); ?>" type="text/javascript"></script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hr-ky-admin1/resources/views/admin/section/body_links.blade.php ENDPATH**/ ?>